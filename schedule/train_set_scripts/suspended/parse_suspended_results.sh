...
./parse_to_suspended_par10.py $data_directory $order_file $timeout_file 1 $seeds $granularity | tr -d '\n'
echo -n ','
./parse_to_suspended_fraction_certain.py $data_directory $order_file $timeout_file 1 $seeds $granularity | tr -d '\n'
echo -n ','
